package dev.edgeahz.userapi.controller;

import dev.edgeahz.userapi.domain.dto.UserDto;
import dev.edgeahz.userapi.domain.entity.User;
import dev.edgeahz.userapi.domain.model.ResponseApi;
import dev.edgeahz.userapi.domain.model.TokenResponseApi;
import dev.edgeahz.userapi.service.UserService;
import dev.edgeahz.userapi.util.CommonUtil;
...
public class UserController {
    ...
    public ResponseEntity<ResponseApi<UserDto>> signup(@Valid @RequestBody UserDto request) {
        ...
        responseApi.setMessage(CommonUtil.getMessage(this.messageSource, "user.signup.successful"));

...
import dev.edgeahz.userapi.domain.dto.PhoneDto;
...
class UserServiceImplTest {
    ...
    void store_whenUserIsNew_shouldReturnOptionalUser() {
        ...
        assertEquals(getDummyRequest().getEmail(), userOptional.get().getEmail());
    ...
    void store_whenUserExist_shouldThrowAnException_emailFound() {
        ...
        assertTrue(userApiActionException.getMessage().contains("user.found"));
    }
    ...
    void store_whenPhoneExist_shouldThrowAnException_phoneFound() {
        ...
        assertTrue(userApiActionException.getMessage().contains("phone.found"));
    }
    ...
    void search_whenUserNotExist_shouldThrowAnException_userNotFound() {
        ...
        assertTrue(userApiActionException.getMessage().contains("user.not.found"));
    }
    ...
    void authenticate_whenUserNotExist_shouldThrowAnException_userNotFound() {
        ...
        assertTrue(userApiActionException.getMessage().contains("email.not.found"));
    }
    ...
    void authenticate_whenUserNotExist_shouldThrowAnException_unauthorized() {
        ...
        assertTrue(jwtAttemptAuthenticationException.getMessage().contains("user.signin.failed"));
    ...
    void search_whenGetAll_shouldReturnUserList() {
        ...
        assertEquals(getDummyRequest().getEmail(), userList.get(0).getEmail());
